...
def main():
    ...
    guess = [0, 0, 0];
    print "Questao 3 - A - Metodo Gauss Seidel\n"
    final = []
    print "Matrix - ", matrix
    Ann = GaussSeidel(matrix)
    for i in range(10):
        print ' Iteracao',i+1
        guess = Ann.run(guess)
        print ' Chute -',(guess)
    ...
    print "Questao 3 - B - Metodo Gauss Seidel\n"
    print "Matrix - ", matrix
    final = []
    Ann = GaussSeidel(matrix)
    for i in range(10):
    ...
    print "Questao 3 - C - Metodo Gauss Seidel\n"
    print "Matrix - ", matrix
    final = []
    Ann = GaussSeidel(matrix)
    for i in range(10):
    ...
    print "Questao 3 - D - Metodo Gauss Seidel\n"
    print "Matrix - ", matrix
    final = []
    Ann = GaussSeidel(matrix)
    for i in range(10):
